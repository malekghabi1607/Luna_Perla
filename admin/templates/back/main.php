<!-- Contenu principal de la page index, utilisant la classe CSS "padding_index" pour le style -->
<main class="padding_index">
    <div class="website-intro">
        ...
        <div class="intro-content">
            ...
            <div class="intro-images">
                <img src="<?php echo $racine_path; ?>templates/back/images/bague-elegante.jpg" alt="Collection de bijoux Luna Perla">
                <img src="<?php echo $racine_path; ?>templates/back/images/collier-joana-1.jpg" alt="Bijoux élégants Luna Perla">
            </div>
        </div>
    </div>
</main>